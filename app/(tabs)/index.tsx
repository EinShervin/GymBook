...
const DayChip: React.FC<DayChipProps> = React.memo(({ day, isSelected, onSelect }) => {
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.8}>
      {isSelected ? (
        <Text style={[styles.dayLabel, styles.dayLabelSelected]}>{day.label}</Text>
      ) : (
      ...
      <View style={[styles.dayIndicator, !isSelected && styles.dayIndicatorHidden]} />
    </TouchableOpacity>
  );
});
