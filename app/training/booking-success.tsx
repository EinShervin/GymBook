    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView
        ...
        <View style={styles.iconWrapper}>
          ...
          <MaterialIcons name="check-circle" size={120} color="#3b82f6" style={styles.icon} />
        </View>
          ...
          <View style={styles.cardDetails}>
            <View style={styles.cardDetailBlock}>
              ...
              <View style={styles.cardDetailRow}>
                <MaterialIcons name="calendar-today" size={16} color="rgba(159,176,216,0.7)" />
            ...
            <View style={styles.cardDetailBlock}>
              ...
              <View style={styles.cardDetailRow}>
                <MaterialIcons name="schedule" size={16} color="rgba(159,176,216,0.7)" />
        ...
        <View style={styles.reservedBadge}>
          <MaterialIcons name="confirmation-number" size={16} color="#3b82f6" />
      ...
      <View style={[styles.bottomBar, { paddingBottom: 24 + insets.bottom }]}>
        <TouchableOpacity style={styles.secondaryButton} activeOpacity={0.8} onPress={handleCalendarPress}>
          <MaterialIcons name="event" size={18} color="#f4f7ff" />
...
const styles = StyleSheet.create({
  ...
  cardDivider: {
    height: 1,
    backgroundColor: 'rgba(159,176,216,0.2)',
    marginBottom: 16,
  },
  cardDetails: {
    gap: 16,
